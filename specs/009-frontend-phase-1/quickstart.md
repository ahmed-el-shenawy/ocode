...
├── components/     # UI components (empty in Phase 1, populated in later phases)
├── hooks/          # Custom React hooks (empty in Phase 1)
├── lib/            # API client, auth, utilities
├── stores/         # Zustand state stores (empty in Phase 1)
